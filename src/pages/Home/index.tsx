...
export const Home = () => {
    ...
    const [monthSeleted, setMonthSelected] = useState((new Date().getMonth() + 1).toString().padStart(2, '0'))
    const [yearSeleted, setYearSelected] = useState(new Date().getFullYear().toString())
    ...
    const handleGetDashboard = async () => {
        ...
        const response = await getDashboard(monthSeleted, yearSeleted)
